...
const AuthenticatedResources = () => {
  return (
    <div className="bg-white min-h-screen">
      ...
      <main className="container mx-auto px-4 md:px-8 py-6 md:py-12">
        {/* Header Section */}
        <header className="mb-8 md:mb-12">
          ...
          {/* Scrolling Navigation Tabs for Mobile */}
          <div className="flex gap-6 md:gap-8 text-sm text-gray-400 border-b border-gray-100 pb-4 overflow-x-auto no-scrollbar whitespace-nowrap">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="group cursor-pointer">
              <div className="relative h-56 md:h-64 w-full rounded-2xl overflow-hidden mb-4 bg-gray-100">
                  <img src="/images/How I became a Rhodes Scholar.png" className="w-full h-full object-cover group-hover:scale-105 transition duration-300" />
              </div>
            ...
            <div className="group cursor-pointer">
              <div className="relative h-56 md:h-64 w-full rounded-2xl overflow-hidden mb-4 bg-gray-100">
                  <img src="/images/how-it-works.jpg" className="w-full h-full object-cover group-hover:scale-105 transition duration-300" />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="relative h-60 md:h-80 w-full rounded-2xl md:rounded-3xl overflow-hidden shadow-lg">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-12 h-12 md:w-16 md:h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/40">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-500 text-sm md:text-base leading-relaxed">Get a taste of what GDC has to offer with our free resources, designed to help you on your college application journey.</p>
        ...
        {/* Opportunity Banner */}
        <section className="mb-10 md:mb-20 bg-blue-950 rounded-2xl md:rounded-[40px] py-10 md:py-16 px-6 md:px-12 text-center text-white">
