...
export default function Hero() {
  return (
    <>
      <div className='w-full h-max bg-white flex flex-col items-center md:flex-row md:h-[calc(100vh-9rem)]'>

        <div className='w-full max-w-lg flex-1 bg-white flex flex-col items-center gap-4 p-4 md:w-1/2 md:max-w-none lg:px-12 md:gap-8'>
          ...
          <p className='w-full max-w-md text-neutral-600 text-start text-pretty md:max-w-none'>
            At GDC, we connect ambitious teenagers with mentors and professors from the very universities they dream of attending.
          </p>
          <Button className='w-full h-fit bg-[#070750] py-2 my-4 md:w-fit md:text-lg md:mr-auto'>Start Your journey Now <ArrowRight/></Button>

          <div className='w-full h-fit flex justify-evenly md:w-full'>
        ...
        <div className='w-full h-max md:h-full md:w-1/2 flex items-center justify-start'>
